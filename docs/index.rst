.. stoQ documentation master file, created by
   sphinx-quickstart on Fri Nov  2 10:57:07 2018.
...
.. image:: https://img.shields.io/pypi/pyversions/stoq-framework.svg
    :target: https://pypi.org/project/stoq-framework/
.. image::  https://api.travis-ci.org/PUNCH-Cyber/stoq.svg?branch=master
    :target: https://api.travis-ci.org/PUNCH-Cyber/stoq.svg?branch=master
...
when compared to other solutions available. Some key differences are:
    ...
    - Extensive up-to-date `documentation <https://stoq-framework.readthedocs.io>`_.
