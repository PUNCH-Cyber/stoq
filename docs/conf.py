...
version = 'v' + stoq.__version__[:2]
# The full version, including alpha/beta/rc tags
release = 'v' + stoq.__version__
...
latex_documents = [
    (master_doc, 'stoQ.tex', 'stoQ Documentation', 'Marcus LaFerrera', 'manual')
]
...
man_pages = [(master_doc, 'stoq', 'stoQ Documentation', [author], 1)]
